...
const Members = () => {
    ...
    return (
        <div className="p-8 font-medium w-full h-full overflow-auto">
            ...
            <Card>
                <FilterSearch members={members} setMembers={setMembers} itemsPerPage={itemsPerPage} setItemsPerPage={setItemsPerPage} />
                <MembersTable members={currentMembers} itemsPerPage={itemsPerPage} />
                <Pagination itemsPerPage={itemsPerPage} pageNumber={pageNumber} setPageNumber={setPageNumber} length={members.length} />
            </Card>
        </div>
    )
}
